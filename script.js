...
actionSheet.src = assetUrl("assets/gorilla-action-sheet.png");
const damageSheet = new Image();
damageSheet.src = assetUrl("assets/building-damage-sheet.png");
const holeMaskSheet = new Image();
holeMaskSheet.src = assetUrl("assets/building-hole-sheet.png");
const carSheet = new Image();
carSheet.src = assetUrl("assets/car-sprites-normalized.png");
